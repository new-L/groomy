...
public class Field : MonoBehaviour
{
    ...
    {
        if (!isFieldEmpty(LoginInputField) || !isFieldEmpty(PasswordIpnutField)) { _notification.Set(NotificationType.Attention, "ќдин из полей пуст!"); _notification.Play(); return; }
